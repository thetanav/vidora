    ...
    <main className="relative min-h-screen overflow-hidden">
      ...
      <div className="flex min-h-screen flex-col items-center justify-center px-6">
        ...
        <Link href="/" className="mb-8 flex items-center gap-2">
          <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-violet-500 to-indigo-500 shadow-lg shadow-primary/20">
        ...
        {/* Login Card */}
        <div className="w-full max-w-sm rounded-2xl border bg-card/50 p-8 backdrop-blur">
